...
# Upload do arquivo
uploaded_file = st.sidebar.file_uploader("Faça upload do dataset CSV", type=["csv"])

if uploaded_file is not None:
    df = pd.read_csv(uploaded_file)
else:
    st.warning('Por favor, envie o arquivo CSV para visualizar os dados.')
    st.stop()
...
# ========== Análise Cruzada ==========
st.subheader('📊 Análise Cruzada - Glicose Média por Faixa Etária e Gênero')
